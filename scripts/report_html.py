...
def build(cohort: dict, op_price: list) -> str:
    ...
    charts = {
        ...
        "flow": [
            ...
            {"label": "Delivered to the claim contract, never claimed", "value": 1268000, "color": C["butter"]},
...
<section id="short">
  ...
  <div class="measure">
    <ul>
      ...
      <li><strong>Grantees were not the slow part.</strong> From application to the first day of incentives took a median of 71 days, of which the team's own launch step was a median of 15. Lesson 2 breaks it down. The year in the schedule was the allowance, not the work.</li>
...
<section id="lessons">
  ...
  2025: 40acres in September, and the other 23 between 2 October and 17 December. Teams had about a year to run the work end to end. A year on, several approved grants
  ...
  <div class="tablewrap"><table>
    ...
    <tbody>
      ...
      <tr><th scope="row">Approved → OP delivered</th><td class="num">34 days</td><td class="num">18–54</td></tr>
      <tr><th scope="row">OP delivered → incentives live</th><td class="num">15 days</td><td class="num">−22 to 136</td></tr>
  ...
  41 report</a> on Sep 12, OP delivered Sep 30, claimed Oct 7, distribution
  ...
  <div class="measure">
    <ul>
      ...
      <li><strong>1.27M OP was delivered to the claim contract and never claimed by the grantee:</strong> Morpho 600k, Tydro 600k, LiqPass 32k, Strands 28k, NEUS 8k. None of it has left the contract, which is visible on-chain. Treat the 1.27M as potentially recoverable and worth pursuing, not as recovered. LiqPass was withdrawn outright.</li>
    </ul>
